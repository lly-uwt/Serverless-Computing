...
public class Response {
    ...
    public Response(String value, String uuid, long cpuusr, long cpukrn,
            ...
            long vmcpusteal, long vuptime, int newcontainer, int totalPrimeNum, long wallTime) {
        ...
        this.totalPrimeNum = totalPrimeNum;
    ...
    public void setTotalPrimeNum(int totalPrimeNum) {
        this.totalPrimeNum = totalPrimeNum;
    }
    ...
    public String toString() {
        return "value=" + this.getValue() + "\nuuid=" + this.getUuid() + "\ncpuusr="
                ...
                + "\ntotalprimenum=" + this.totalPrimeNum + "\nwalltime=" + this.wallTime;
    }
}
