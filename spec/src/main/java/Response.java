...
public class Response {
    ...
    String bmname, bmscore, bmthreads;
    long bmtotalduration;
    ...
    public Response(String value, String uuid, long cpuusr, long cpukrn,
            ...
            long vmcpusteal, long vuptime, int newcontainer, String bmname,
            String bmscore, String bmthreads, long bmtotalduration) {
        ...
        this.bmthreads = bmthreads;
        this.bmtotalduration = bmtotalduration;
    }
    ...
    public void setBmscore(String bmscore) {
        this.bmscore = bmscore;
    }

    public String getBmthreads() {
        return this.bmthreads;
    }

    public void setBmthreads(String bmthreads) {
        this.bmthreads = bmthreads;
    }

    public long getBmtotalduration() {
        return this.bmtotalduration;
    }

    public void setBmtotalduration(long bmtotalduration) {
        this.bmtotalduration = bmtotalduration;
    }
